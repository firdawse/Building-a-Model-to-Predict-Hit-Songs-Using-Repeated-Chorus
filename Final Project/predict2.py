...
def download_song(song_name, artist_name):
    ...
    ydl_opts = {
        ...
        'outtmpl': output_file,
        # 'audioformat': "wav",
        'ffmpeg_location': r"D:/Cources/Hit Songs/Final phase/ffmpeg-master-latest-win64-gpl/bin/ffmpeg.exe",
        'ffprobe_location': r"D:/Cources/Hit Songs/Final phase/ffmpeg-master-latest-win64-gpl/bin/ffprobe.exe"
    }
